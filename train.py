...
model_load = "ppo_f16_eleva_v2.1.5.zip"         #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
model_path = "ppo_f16_eleva_v2.1.6.zip" 
vecnorm_load = "vecnorm_eleva_v2.1.5.pkl"       #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
vecnorm_path = "vecnorm_eleva_v2.1.6.pkl"
...
if __name__ == "__main__":
    ...
    #model = PPO("MlpPolicy", env, verbose = 1, n_steps=512, batch_size=1024, gamma = 0.997, ent_coef = 0.01, tensorboard_log="./tb_logs/") #ent_coef controls how much PPO encourage exploration 

    model.learn(total_timesteps= 1_200_000,reset_num_timesteps=False, tb_log_name="v2.0.8") #reset_num_timesteps=False (Add when train continous, remove when train fresh)
