...
model_path = "ppo_f16_eleva_v2.0.0.zip" 
...
if __name__ == "__main__":
    ...
    model.learn(total_timesteps= 1_600_000, tb_log_name="v2.0.0") #reset_num_timesteps=False (Add when train continous, remove when train fresh)
