...
model_load = "ppo_f16_eleva_v1.9.0.zip"         #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
model_path = "ppo_f16_eleva_v1.9.1.zip" 
vecnorm_load = "vecnorm_eleva_v1.9.0.pkl"       #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
...
if __name__ == "__main__":
    ...
    model.learn(total_timesteps= 1_000_000,reset_num_timesteps=False, tb_log_name="v1.9.1") #reset_num_timesteps=False (Add when train continous, remove when train fresh)
