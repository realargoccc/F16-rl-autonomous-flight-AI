...
if __name__ == "__main__":
    ...
    model.learn(total_timesteps= 1_200_000, tb_log_name="v2.0.8") #reset_num_timesteps=False (Add when train continous, remove when train fresh)
