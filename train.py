...
model_load = "ppo_f16_eleva_v2.1.8.zip"         #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
model_path = "ppo_f16_eleva_v2.1.9.zip" 
vecnorm_load = "vecnorm_eleva_v2.1.8.pkl"       #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
vecnorm_path = "vecnorm_eleva_v2.1.9.pkl"
...
if __name__ == "__main__":
    ...
    model.learn(total_timesteps= 1_200_000, reset_num_timesteps=False, tb_log_name="v2.1.9") #reset_num_timesteps=False (Add when train continous, remove when train fresh)
