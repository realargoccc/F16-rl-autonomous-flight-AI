...
if __name__ == "__main__":
    ...
    model.learn(total_timesteps= 1_600_000, reset_num_timesteps=False, tb_log_name="v2.0.2") #reset_num_timesteps=False (Add when train continous, remove when train fresh)
