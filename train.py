...
model_load = "ppo_f16_eleva_v2.8.2.zip"         #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
model_path = "ppo_f16_eleva_v2.8.3.zip" 
vecnorm_load = "vecnorm_eleva_v2.8.2.pkl"       #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
vecnorm_path = "vecnorm_eleva_v2.8.3.pkl"

def make_env():
    env = F16Env()
    env.aspect_band = (0.0, 80.0)
    env.defensive_p = 0.5
    foe_pool = ["v2.8.0", "v2.8.1", "v2.8.2"]
