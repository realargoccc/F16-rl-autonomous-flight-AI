...
model_load = "ppo_f16_eleva_v2.8.7.zip"         #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
model_path = "ppo_f16_eleva_v2.8.8.zip" 
vecnorm_load = "vecnorm_eleva_v2.8.7.pkl"       #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
vecnorm_path = "vecnorm_eleva_v2.8.8.pkl"

def make_env():
    env = F16Env()
    env.aspect_band = (0.0, 80.0)
    env.defensive_p = 0.5
    foe_pool = ["v2.8.0", "v2.8.1", "v2.8.2", "v2.8.3", "v2.8.4", "v2.8.5", "v2.8.6", "v2.8.7"]
...
if __name__ == "__main__":
    ...
    model.learn(total_timesteps= 2_000_000,reset_num_timesteps=False, tb_log_name="v2.8.1") #reset_num_timesteps=False (Add when train continous, remove when train fresh)
