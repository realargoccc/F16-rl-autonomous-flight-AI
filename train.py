...
model_load = "ppo_f16_eleva_v2.3.7.zip"         #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
model_path = "ppo_f16_eleva_v2.3.8.zip" 
vecnorm_load = "vecnorm_eleva_v2.3.7.pkl"       #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
