...
model_load = "ppo_f16_eleva_v4.1.3.zip"         #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
model_path = "ppo_f16_eleva_v4.1.4.zip" 
vecnorm_load = "vecnorm_eleva_v4.1.3.pkl"       #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
vecnorm_path = "vecnorm_eleva_v4.1.4.pkl"
...
if __name__ == "__main__":
    ...
    pool = SelfPlayPool(every=snapshot_every, prefix="v4.1.4", warmup=snapshot_warm, prob=pool_prob)
    model.learn(total_timesteps= 3_000_000, callback=pool, reset_num_timesteps=False, tb_log_name="v4.1.4") #reset_num_timesteps=False (Add when train continous, remove when train fresh)
