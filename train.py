...
model_load = "ppo_f16_eleva_v2.6.2.zip"         #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
model_path = "ppo_f16_eleva_v2.6.3.zip" 
vecnorm_load = "vecnorm_eleva_v2.6.2.pkl"       #COMMEWNT OUT WHEN TRAIN FRESH, UN COMMENT WHEN TRAIN CONTINUOUS
vecnorm_path = "vecnorm_eleva_v2.6.3.pkl"
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        model.policy.log_std.fill_(-1.2) # hard set the explore of each axis to 0.5 (avoiding bang bang)
